...
export default function HomePage() {
  ...
  return (
    <CenteredPage>
      ...
      <img src={`${import.meta.env.BASE_URL}cards.png`} alt="Cards" style={{ maxWidth: '18.75rem', width: '100%', margin: '0.5rem 0' }} />
      <p>
      ...
      <div style={{ marginTop: '1.25rem', display: 'flex', gap: '1.5rem', justifyContent: 'center', alignItems: 'center' }}>
